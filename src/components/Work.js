export const projects = [
  ...
  },
  {
    ...
    name: "first light",
    description:
      "First Light began as a vanillaJS project, but has now morphed into a full-blown React app, with future plans for React Native deployment.  It's under construction, with the latest deployed version on the *url* *branch*, but will soon provide users with an opportunity to gain perspective for their day through verses from the Bible, astrophotography, and list-capture.",
