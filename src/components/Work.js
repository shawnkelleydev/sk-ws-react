export const projects = [
  ...
  },
  {
    year: 2021,
    name: "tomorrow land",
    shortDesc: "A quick and simple budgeting app.",
    description: [
      "Tomorrow Land is a quick and simple budgeting application.",
      "It's built with React and React Router and manages state from the URL, enabling easy sharability.",
    ],
